    ...
    private void startLoading() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(pref.getString("firstCheck","false").equals("true")){
                    intent = new Intent(LoadingActivity.this, StartActivity.class);

                }else{
                    intent = new Intent(LoadingActivity.this ,NoticeActivity.class);
                }
