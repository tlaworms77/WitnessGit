...
public class VideoViewGroup extends RelativeLayout {
    ...
    public void sendt(PlayRTCActivity activity){
        Log.i("W.T.F", "되니?");
        listView=(ListView)activity.findViewById(R.id.chatview);
    }
    //-------------------------------------------------------------------------------------------------------------//
    ...
    public void resizeLocalVideoView(RTCViewSizeType size) {
        ...
        if(size == RTCViewSizeType.Full) {
            ...
            // 세로 모드임, 해상도는 가로 기준
            int smallWidth = (int)(screenDimensions.x*0.15);//------------------- ---------------------------------------this is change of size of local
            int samllHeight = (int)(screenDimensions.y*0.27);
    ...
    private void createLocalVideoView (final Point screenDimensions) {
        ...
        if(localView == null) {
            ...
            //displaySize.x = (int)(screenDimensions.x*0.5);
            displaySize.x = (int)(screenDimensions.x);
            //displaySize.y = (int)(screenDimensions.y*0.5);
    ...
    private void initLocalVideo() {
        ...
        // 부모 View의 30% 비율로 크기를 지정한다
        int width = (int)(screenDimensions.x);
        int height = (int)(screenDimensions.y);
